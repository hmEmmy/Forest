...
public class HubSelectorMenu extends Menu {
    ...
    public HubSelectorMenu() {
        this.refillGlassButton = new RefillGlassButton(
                ...
                FlowerHub.getInstance().getConfig("menus.yml").getInt("menus.hub_selector.refill-glass.data", 15),
    ...
    public String getTitle(Player player) {
        return CC.translate(FlowerHub.getInstance().getConfig("menus.yml").getString("menus.hub_selector.title"));
    }
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        ConfigurationSection serversSection = FlowerHub.getInstance().getConfig("menus.yml").getConfigurationSection("menus.hub_selector.servers");
        ...
        ConfigurationSection refillGlassSection = FlowerHub.getInstance().getConfig("menus.yml").getConfigurationSection("menus.hub_selector.refill-glass");
    ...
    @Override
    public int getSize() {
        ConfigurationSection menuSection = FlowerHub.getInstance().getConfig("menus.yml").getConfigurationSection("menus.hub_selector");
